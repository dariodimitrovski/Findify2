...
@Component
class JwtAuthenticationFilter(private val authenticationManager: AuthenticationManager, private val tokenService: TokenService, private val userDetailsService: UserDetailsService) : OncePerRequestFilter() {
    ...
    override fun doFilterInternal(
        ...
        if (userId != null && SecurityContextHolder.getContext().authentication == null) {
            val userDetails = this.userDetailsService.loadUserByUsername(userId.toString())
...
//            }
    ...
    override fun shouldNotFilter(request: HttpServletRequest): Boolean {
        return request.servletPath.startsWith("/api/auth/login") ||
                ...
                request.servletPath.startsWith("/api/posts/") || request.servletPath.startsWith("/api/comments/") ||
