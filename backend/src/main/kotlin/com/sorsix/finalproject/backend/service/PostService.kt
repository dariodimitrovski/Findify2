...
interface PostService {
    ...
    fun create(title: String, category: Category, description: String, municipality: Municipality, image: MultipartFile, status: PostStatus, location: Location, time: String, user: User): Post
