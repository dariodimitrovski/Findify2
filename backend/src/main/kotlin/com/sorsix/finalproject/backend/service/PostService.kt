...
interface PostService {
    ...
    fun create(title: String, category: Category, description: String, municipality: Municipality, image: MultipartFile, status: PostStatus, user: User, location: Location, time: String): Post
